function Wing_VortexRing_BATCH
    ...
    M_input = xlsread([PathName FileName],'ENTERA','B2:F4');
    M_output = zeros(size(M_input,1),5);
    for i=1:size(M_input,1)
        ...
        M_output(i,:) = [output_struct.Ar  output_struct.CLCDi output_struct.CL output_struct.CDi output_struct.alpha];
    end
